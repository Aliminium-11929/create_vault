...
class UserControllerTests {
        ...
        void getAllUsers_returnsAllUsers() {
                ...
                User user = userRepository
                                .saveAndFlush(User.builder().id(10L).name("Grace Hopper").email("grace@example.com")
        ...
        void getUserById_returnsUserStorageModel() {
                ...
                User user = userRepository
                                .saveAndFlush(User.builder().id(11L).name("Alan Turing").email("turing@example.com")
        ...
        void deleteUserById_removesUser() {
                ...
                User user = userRepository
                                .saveAndFlush(User.builder().id(13L).name("Delete Me").email("delete@example.com")
                                                .role(UserRole.STUDENT).field(field).build());
        ...
        void createUser_withInvalidEmail_returnsBadRequest() {
                Field field = fieldRepository.saveAndFlush(Field.builder().name("Math").build());
        ...
        @Test
        void createUser_withUnknownFieldId_returnsBadRequest() {
                UserCreateModel request = new UserCreateModel();
                request.setId(202L);
                request.setName("No Field");
                request.setEmail("nofield@example.com");
                request.setRole(UserRole.STUDENT);
        ...
        @Test
        void createUser_withNullFieldId_returnsBadRequest() {
                UserCreateModel request = new UserCreateModel();
                request.setId(203L);
                request.setName("Null Field User");
                request.setEmail("nullfield@example.com");
