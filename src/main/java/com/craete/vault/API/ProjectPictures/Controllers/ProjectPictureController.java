...
public class ProjectPictureController {
    ...
    @PostMapping
    public ProjectPictureStorageModel createProjectPicture(@Valid @RequestBody ProjectPictureCreateModel projectCreateModel) {
        return projectPictureService.createProjectPicture(projectCreateModel);
    }

    @PatchMapping
    public ProjectPictureStorageModel patchProjectPicture(@Valid @RequestBody ProjectPicturePatchModel projectPatchModel) {
